...
function file_code(path) {
  ...
  $.post("",
    function (data) {
      ...
      var size = formatFileSize(obj.size);
      var content = `
<link rel="stylesheet" href="https://raw.githubusercontent.com/PrismJS/prism/master/themes/prism-twilight.css" integrity="sha256-Rl83wx+fN2p2ioYpdvpWxuhAbxj+/7IwaZrKQBu/KQE=" crossorigin="anonymous">
<div class="container"><br>
<div class="card text-center">
<div class="card-body text-center">
  <div class="${UI.file_view_alert_class}" id="file_details" role="alert">${obj.name}<br>${size}</div>
...
<script src="https://raw.githubusercontent.com/PrismJS/prism/master/prism.js" integrity="sha256-fZOd7N/oofoKcO92RzxvC0wMm+EvsKyRT4nmcmQbgzU=" crossorigin="anonymous"></script>
`;
      $('#content').html(content);
    });
...
function file_pdf(path) {
  ...
  pdfjsLib.GlobalWorkerOptions.workerSrc = '//raw.githubusercontent.com/mozilla/pdf.js/gh-pages/build/pdf.worker.js';
  var pdfDoc = null,
      pageNum = 1,
      pageRendering = false,
      pageNumPending = null,
