...
function getDocumentHeight() { var e = document; return Math.max(e.body.scrollHeight, e.documentElement.scrollHeight, e.body.offsetHeight, e.documentElement.offsetHeight, e.body.clientHeight, e.documentElement.clientHeight) }
...
function gdidecode(e) {
    ...
    }(t), decodeURIComponent(atob(e).split("")[n(363)](function(e) { var t = n; return "%" + ("00" + e[t(358)](0)[t(356)](16)).slice(-2) })[n(355)](""))
}

function render(e) {
    e.indexOf("?") > 0 && (e = e.substr(0, e.indexOf("?"))), title(e), nav(e);
    window.MODEL.is_search_page ? (window.scroll_status = { event_bound: !1, loading_lock: !1 }, render_search_result_list()) : e.match(/\/\d+:$/g) || "/" == e.substr(-1) ? (window.scroll_status = { event_bound: !1, loading_lock: !1 }, list(e)) : file(e)
}
...
function requestListPath(e, t, n, a) {
    var i = { password: t.password || null, page_token: t.page_token || null, page_index: t.page_index || 0 };
    $.post(e, i, function(t, o) {
        var l = jQuery.parseJSON(gdidecode(read(t)));
        l && l.error && "401" == l.error.code ? a && a(e) : l && l.data && n && n(l, e, i)
    })
}

function requestSearch(e, t) {
    var n = { q: e.q || null, page_token: e.page_token || null, page_index: e.page_index || 0 };
...
function list(e) {
    var t = `<div class="container">${UI.fixed_header ? "<br>" : ""}\n\t<div id="update"></div>\n    <div id="head_md" style="display:none; padding: 20px 20px;"></div>\n    <div class="${UI.path_nav_alert_class} d-flex align-items-center" role="alert" style="margin-bottom: 0; padding-bottom: 0rem;">\n  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">\n    <ol class="breadcrumb" id="folderne"><li class="breadcrumb-item"><a href="/">Home</a></li>`,
        ...
        i = (decodeURIComponent(a).split("/"), a.trim("/").split("/")),
        o = "/";
    if (i.length > 1)
        for (var l in i.shift(), i) {
            var s = i[l];
            n1 = decodeURIComponent(s), n2 = n1.replace(/\?.+/g, "$'"), n2.length > 15 ? n = n2.slice(0, 5) + "..." : n = n2.slice(0, 15);
            (o += s + "/").split(".").pop().toLowerCase();
            if ("" === n) break;
            t += `<li class="breadcrumb-item"><a href="${o}">${n}</a></li>`
        }
    ...
    $("#list").html(`<div class="d-flex justify-content-center"><div class="spinner-border ${UI.loading_spinner_class} m-5" role="status"><span class="sr-only"></span></div></div>`), $("#readme_md").hide().html(""), $("#head_md").hide().html(""), requestListPath(e, { password: r }, function e(t, n, a) {
        $("#list").data("nextPageToken", t.nextPageToken).data("curPageIndex", t.curPageIndex), $("#spinner").remove(), null === t.nextPageToken ? ($(window).off("scroll"), window.scroll_status.event_bound = !1, window.scroll_status.loading_lock = !1, append_files_to_list(n, t.data.files)) : (append_files_to_list(n, t.data.files), !0 !== window.scroll_status.event_bound && ($(window).on("scroll", function() {
            ...
            if (t + $(this).height() > i - (Os.isMobile ? 130 : 80)) {
                ...
                let t = $("#list");
                requestListPath(n, { password: a.password, page_token: t.data("nextPageToken"), page_index: t.data("curPageIndex") + 1 }, e, null)
            }
...
function append_files_to_list(e, t) {
    ...
    for (i in t) {
        ...
        if (null == s.size && (s.size = ""), s.modifiedTime = utc2delhi(s.modifiedTime), s.size = formatFileSize(s.size), "application/vnd.google-apps.folder" == s.mimeType) html += `<a href="${r}" style="color: ${UI.folder_text_color};" class="list-group-item list-group-item-action"><svg width="1.5em" height="1.5em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><linearGradient id="WQEfvoQAcpQgQgyjQQ4Hqa" x1="24" x2="24" y1="6.708" y2="14.977" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#eba600"></stop><stop offset="1" stop-color="#c28200"></stop></linearGradient><path fill="url(#WQEfvoQAcpQgQgyjQQ4Hqa)" d="M24.414,10.414l-2.536-2.536C21.316,7.316,20.553,7,19.757,7L5,7C3.895,7,3,7.895,3,9l0,30\tc0,1.105,0.895,2,2,2l38,0c1.105,0,2-0.895,2-2V13c0-1.105-0.895-2-2-2l-17.172,0C25.298,11,24.789,10.789,24.414,10.414z"></path><linearGradient id="WQEfvoQAcpQgQgyjQQ4Hqb" x1="24" x2="24" y1="10.854" y2="40.983" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#ffd869"></stop><stop offset="1" stop-color="#fec52b"></stop></linearGradient><path fill="url(#WQEfvoQAcpQgQgyjQQ4Hqb)" d="M21.586,14.414l3.268-3.268C24.947,11.053,25.074,11,25.207,11H43c1.105,0,2,0.895,2,2v26\tc0,1.105-0.895,2-2,2H5c-1.105,0-2-0.895-2-2V15.5C3,15.224,3.224,15,3.5,15h16.672C20.702,15,21.211,14.789,21.586,14.414z"></path></svg> ${s.name} ${UI.display_time ? '<span class="badge bg-info float-end"> ' + s.modifiedTime + " </span>" : ""}</a>`;
            ...
            s.name;
            a && "README.md" == s.name && UI.render_readme_md && get_file(r, s, function(e) { markdown("#readme_md", e), $("img").addClass("img-fluid") }), "HEAD.md" == s.name && UI.render_head_md && get_file(r, s, function(e) { markdown("#head_md", e), $("img").addClass("img-fluid") });
    ...
    } if (l.length > 0) { let t = localStorage.getItem(e), n = l; if (!o && t) { let e; try { e = JSON.parse(t), Array.isArray(e) || (e = []) } catch (t) { e = [] } n = e.concat(l) } localStorage.setItem(e, JSON.stringify(n)) } n.html(("0" == n.data("curPageIndex") ? "" : n.html()) + html), a && $("#count").removeClass("d-none").find(".number").text(n.find("a.list-group-item-action").length)
